...
@haystack_action
def store_documents(name: str, data: Dict[str, Any], parameters: Dict[str, Any], outgoing_edges: List[str], stores: Dict[str, Any]):    
    ...
    stores[store_name].write_documents(documents=data[input_variable_name], index=index, duplicates=duplicates)
